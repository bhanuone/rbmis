class Admin::TreatmentCategoriesController < ApplicationController
  before_action :authenticate_admin!
  before_action :set_treatment_category, only: [:show, :edit, :update, :destroy]

  # GET /treatment_categories
  # GET /treatment_categories.json
  def index
    @treatment_categories = TreatmentCategory.all
  end

  # GET /treatment_categories/1
  # GET /treatment_categories/1.json
  def show
  end
  ...
  # POST /treatment_categories
  # POST /treatment_categories.json
  def create
  ...
  # PATCH/PUT /treatment_categories/1
  # PATCH/PUT /treatment_categories/1.json
  def update
    respond_to do |format|
  ...
  # DELETE /treatment_categories/1
  # DELETE /treatment_categories/1.json
  def destroy
  ...
  private
    ...
    def treatment_category_params
      params.require(:treatment_category).permit(:name)
    end
end
